...
<div class="container">
    <f:parseDate value="20-10-2010" var="parsedEmpDate" scope="page" pattern="dd-mm-yyyy"/>
<%--    <c:set var="salary" scope="page" value="${2*22}"/>--%>
    <div class="row">
